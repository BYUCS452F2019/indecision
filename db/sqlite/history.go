...
func (s *DB) CreateHistoryRecord(record structs.HistoryRecord) (structs.HistoryRecord, error) {
...
func (s *DB) GetHistoryRecord(id string) (structs.HistoryRecord, error) {
	var toReturn structs.HistoryRecord
...
func (s *DB) UpdateHistoryRecord(id string, record structs.HistoryRecord) (structs.HistoryRecord, error) {
	var toReturn structs.HistoryRecord
...
func (s *DB) DeleteHistoryRecord(id string) error {
	return nil
}

// GetHistoryRecordsByUser gets all of the records associated with a certain user
func (s *DB) GetHistoryRecordsByUser(userID string) ([]structs.HistoryRecord, error) {
	var toReturn []structs.HistoryRecord
...
func (s *DB) GetLastRecordByUser(userID string) (structs.HistoryRecord, error) {
	var toReturn structs.HistoryRecord
...
func (s *DB) GetHistoryRecordsByChoice(choiceID string) ([]structs.HistoryRecord, error) {
	var toReturn []structs.HistoryRecord
...
func (s *DB) GetLastRecordByChoice(choiceID string) (structs.HistoryRecord, error) {
	var toReturn structs.HistoryRecord
